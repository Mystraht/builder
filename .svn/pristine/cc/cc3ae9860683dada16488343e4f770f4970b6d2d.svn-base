...
class Buildings 
{
	...
	public function upgrade(pX:Int, pY:Int,pCallBack:String->Void):Void {
		var request = new Http(Api.formatPath(Api.domain + Api.pathApi + buildingsPath + upgradePath, { token: Api.token, x: pX, y: pY }));
	...
	public function collect(pX:Int, pY:Int,pCallBack:String->Void):Void {
		var request = new Http(Api.formatPath(Api.domain + Api.pathApi + buildingsPath + collectPath, { token: Api.token, x: pX, y: pY }));
	...
	public function move(pX_start:Int, pY_start:Int, pX_end:Int, pY_end:Int, pCallBack:String->Void):Void {
		var request = new Http(Api.formatPath(Api.domain + Api.pathApi + buildingsPath + movePath, { token: Api.token, x_start: pX_start, y_start: pY_start, x_end: pX_end, y_end: pY_end }));
	...
	public function hardBuild(pX:Int, pY:Int, pCallBack:String->Void ):Void {
		var request = new Http(Api.formatPath(Api.domain + Api.pathApi + buildingsPath + hardBuildPath , { token: Api.token, x: pX, y: pY }));
	...
	public function changeColor(pColor:String, pX:Int, pY:Int, pCallBack:String->Void ):Void {
		var request = new Http(Api.formatPath(Api.domain + Api.pathApi + buildingsPath + changeColorPath , { token: Api.token, color: pColor, x: pX, y: pY }));
	...
	public function destroy(pX:Int, pY:Int, pCallBack:String->Void ):Void {
		var request = new Http(Api.formatPath(Api.domain + Api.pathApi + buildingsPath + destroyPath , { token: Api.token, x: pX, y: pY }));
