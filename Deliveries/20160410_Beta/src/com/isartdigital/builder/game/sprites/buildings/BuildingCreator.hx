...
class BuildingCreator {
	...
	private function prepareBuildingObject():Void {
		building = cast PoolObject.create(Type.resolveClass("com.isartdigital.builder.game.sprites.buildings.Building"));
