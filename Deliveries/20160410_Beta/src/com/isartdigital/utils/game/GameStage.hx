...
class GameStage extends Container
{
	 ...
	 * conteneur de parade
	 */
	private var citizenContainer:Container;
	...
	public function new() 
	{
		...
		citizenContainer = new Container();
		gameContainer.addChild(citizenContainer);
	 ...
	 */		
	public function getCitizenContainer ():Container {		
		return citizenContainer;		
	}
