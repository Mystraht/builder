haxe -lib pathfinder -lib actuate -lib dat.GUI -lib eventemitter3 -lib howlerjs -lib jsfps -lib pixijs -lib pixi-flump-runtime -lib WebFont -cp src -js bin/ui.js -xml doc/doc.xml com/isartdigital/builder/Main.hx
