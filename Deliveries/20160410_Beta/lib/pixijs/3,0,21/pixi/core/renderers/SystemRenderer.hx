...
extern class SystemRenderer extends EventEmitter {
	 ...
	 *      not before the MapManagerTest render pass.
	 */
	...
	/**
	 * This sets if the CanvasRenderer will clear the canvas or not before the MapManagerTest render pass.
	 ...
	 *
	 * @param width {Float} the MapManagerTest width of the canvas view
	 * @param height {Float} the MapManagerTest height of the canvas view
	 */
