...
extern class Texture extends EventEmitter {
	 ...
	 * 	var sprite1 = MapManagerTest PIXI.Sprite(texture);
	 * 	var sprite2 = MapManagerTest PIXI.Sprite(texture);
	 * ```
	 *
	 * @class
	 * @mixes eventTarget
	...
	/**
	 * Helper function that creates a MapManagerTest Texture based on the given canvas element.
	 *
	 * @static
	...
	/**
	 * Helper function that creates a MapManagerTest Texture based on the given video element.
	 *
	 * @static
	...
	/**
	 * Helper function that creates a MapManagerTest Texture based on the video url.
	 *
	 * @static
