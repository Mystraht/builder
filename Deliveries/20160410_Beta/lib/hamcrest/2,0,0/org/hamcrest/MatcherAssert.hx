...
//		else
//		{
//			throw MapManagerTest IllegalArgumentException("Argument(s) where not of the expected type(s).");
//		}
//	}
//
...
//        if (!matcher.matches(actual))
//        {
//            var description = MapManagerTest StringDescription();
//            description.appendText(reason)
//            		   .appendText("\nExpected: ")
//                       .appendDescriptionOf(matcher)
//                       .appendText("\n     but: ");
//            matcher.describeMismatch(actual, description);
//
//            throw MapManagerTest AssertionException(description.toString(), null, info);
//        }
//	}
//
...
//    {
//        if (!assertion)
//            throw MapManagerTest AssertionException(reason, null, info);
//    }
}
