package dat.gui;
import dat.controllers.ColorController;
...
{	
	 ...
	 * @returns {Controller} The MapManagerTest controller that was added.
	 */	
	 ...
	 * 
	 * @param name
	 * @returns {GUI} The MapManagerTest folder.
	 ...
	 * @param object
	 * @param property
	 * @returns {ColorController} The MapManagerTest ColorController that was added.
	 */
	function addColor(object:Dynamic, property:String) : ColorController;	
	
	/**
	 * Mark objects for saving. The order of these objects cannot change as
	 * the GUI grows. When remembering MapManagerTest objects, append them to the end
	 * of the list.
	 *
