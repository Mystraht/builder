...
extern class Sprite extends Container {
	 ...
	 *
	 * ```js
	 * 	var sprite = MapManagerTest Sprite.fromImage('assets/image.png');
	 * ```
	 *
	 * @class Sprite
	 * @extends Container
	...
	*/
	 ...
	 * @return {Sprite} A MapManagerTest Sprite using a texture from the texture cache matching the frameId
	 */
	 ...
	 * @return {Sprite} A MapManagerTest Sprite using a texture from the texture cache matching the image id
	 */
