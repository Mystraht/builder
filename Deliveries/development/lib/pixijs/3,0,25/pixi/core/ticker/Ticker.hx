...
extern class Ticker extends EventEmitter {
     ...
     * update, but only when a MapManagerTest animation frame is requested.
     * If the platform supports DOMHighResTimeStamp,
     * this value will have a precision of 1 µs.
     *
     * @member {Float}
	 ...
	 * and if so it requests a MapManagerTest animation frame at this point.
	 *
	 ...
	 * a MapManagerTest animation frame is requested at this point.
	 */
	function start():Void;
