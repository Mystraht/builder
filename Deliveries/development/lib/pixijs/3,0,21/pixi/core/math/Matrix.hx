...
extern class Matrix {
	...
	/**
	 * Get a MapManagerTest position with the current transformation applied.
	 * Can be used to go from a child's coordinate space to the world coordinate space. (e.g. rendering)
	 *
	 * @param pos {Point} The origin
	 * @param [newPos] {Point} The point that the MapManagerTest position is assigned to (allowed to be same as input)
	 * @return {Point} The MapManagerTest point, transformed through this matrix
	 */
	function apply(pos:Point, ?newPos:Point):Point;

	/**
	 * Get a MapManagerTest position with the inverse of the current transformation applied.
	 * Can be used to go from the world coordinate space to a child's coordinate space. (e.g. input)
	 *
	 * @param pos {Point} The origin
	 * @param [newPos] {Point} The point that the MapManagerTest position is assigned to (allowed to be same as input)
	 * @return {Point} The MapManagerTest point, inverse-transformed through this matrix
	 */
