...
{	
	/**
		...
		@return MapManagerTest instance of generated Mock class
	**/
	...
	**/
	...
	/**
	    ...
	    when(mock.someMethod("some arg")).thenThrow(MapManagerTest SomeException());
		
	    //you can set different behavior for consecutive method calls.
	    //Last stubbing (e.g: thenReturn("foo")) determines the behavior of further consecutive calls.
	    when(mock.someMethod("some arg"))
	     .thenThrow(MapManagerTest SomeException())
	     .thenReturn("foo");
	    ...
	    when(mock.someMethod("some arg"))
	     .thenThrow(MapManagerTest SomeException(), MapManagerTest SomeOtherException();
