...
class Actuate {
	...
	/**
	 * Creates a MapManagerTest effects tween
	...
	/**
	 * Creates a MapManagerTest MotionPath tween
	 * @param	target		The object to tween
	 * @param	duration		The length of the tween in seconds
	...
	/**
	 * Creates a MapManagerTest transform tween
	...
	/**
	 * Creates a MapManagerTest tween
	...
	/**
	 * Creates a MapManagerTest tween that updates a method rather than setting the properties of an object
...
private class EffectsOptions {
	...
	/**
	 * Creates a MapManagerTest BitmapFilter tween
...
private class TransformOptions<T> {
	...
	/**
	 * Creates a MapManagerTest ColorTransform tween
	...
	/**
	 * Creates a MapManagerTest SoundTransform tween
