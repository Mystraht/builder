...
/**
	Provides a shortcut to all Matchers.
...
class Matchers
{
	...
	**/
	...
	/**
		...
		@param description the MapManagerTest description for the wrapped matcher
	...
	**/
	...
	/**
		...
		For example:
		`assertThat(MapManagerTest Canoe(), instanceOf(Paddlable))`.
	**/
	...
	**/
	...
	/**
		Creates a matcher for `MapManagerTest`s matching when the examined `MapManagerTest` contains at least one
	...
	**/
	public static function hasEntry<K, V>(key:Dynamic, value:Dynamic):Matcher<Map<K, V>>
	{
		return IsHashContaining.hasEntry(key, value);
	}

	/**
		Creates a matcher for `MapManagerTest`s matching when the examined `MapManagerTest` contains
	...
	**/
	public static function hasKey<K, V>(key:Dynamic):Matcher<Map<K, V>>
	{
	...
	**/
	public static function hasValue<K, V>(value:Dynamic):Matcher<Map<K, V>>
	{
