...
ApiTest.prototype = {
	...
	,should_format_path_with_params_object_to_query_format: function() {
		...
		massive_munit_Assert.isTrue(formattedPath == "http://google.com?token=AZERTY123456&x=5&y=10",{ fileName : "ApiTest.hx", lineNumber : 53, className : "ApiTest", methodName : "should_format_path_with_params_object_to_query_format"});
	}
	,__class__: ApiTest
};
var BuildingFactoryTest = function() {
};
$hxClasses["BuildingFactoryTest"] = BuildingFactoryTest;
BuildingFactoryTest.__name__ = ["BuildingFactoryTest"];
BuildingFactoryTest.prototype = {
	beforeClass: function() {
	}
	,afterClass: function() {
	}
...
BuildingTest.prototype = {
	...
	,should_set_tile_under_building_to_not_constructible_state_when_building_is_created: function() {
		...
		var building = new com_isartdigital_builder_game_sprites_Building();
...
var com_isartdigital_builder_game_factory_BuildingFactory = function() {
};
...
com_isartdigital_builder_game_factory_BuildingFactory.prototype = {
	__class__: com_isartdigital_builder_game_factory_BuildingFactory
};
...
BuildingFactoryTest.__meta__ = { fields : { beforeClass : { BeforeClass : null}, afterClass : { AfterClass : null}, setup : { Before : null}, tearDown : { After : null}, should_create_building : { Test : null}}};
